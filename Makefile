...
ACLOCAL = ${SHELL} /root/mdev/nodes/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/mdev/nodes/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/mdev/nodes/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/mdev/nodes/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /root/mdev/nodes/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = zcore
PACKAGE_BUGREPORT = https://github.com/zcore-coin/zcore-source/issues
PACKAGE_NAME = ZCore
PACKAGE_STRING = ZCore 1.6.1
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /root/mdev/nodes
abs_srcdir = /root/mdev/nodes
abs_top_builddir = /root/mdev/nodes
abs_top_srcdir = /root/mdev/nodes
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/mdev/nodes/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/zcored$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/zcore-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/zcore-cli$(EXEEXT)
...
#rpc_test.info: test_zcore_filtered.info
...
#total_coverage.info: baseline_filtered_combined.info test_zcore_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_zcore_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt
...
# ZCore: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_zcore.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
